...
public class NewSchoolSearch6 {
    ...
    private static void SchoolSearch(String school, int pass)throws IOException{
        ...
        PrintWriter foundFile = new PrintWriter("C:/Users/emarcha/Desktop/SchoolSearch/NewSearch2/results/"+ assoc + "/Found/"+ assoc +"ContainsAcms" + pass + "test2.txt");
        //creates a txt file that list all of the schools that do not contain a cms term
        PrintWriter notFoundFile = new PrintWriter("C:/Users/emarcha/Desktop/SchoolSearch/NewSearch2/results/" + assoc + "/NotFound/"+ assoc + "DoesNotContainCMStest2" + pass + ".txt");
        ...
        while((urlstring = br.readLine()) != null){
            ...
            for(String elem : termList){
                //creates Pattern and Matcher to search for each individual term in the source code
                Pattern pattern = Pattern.compile(elem.toLowerCase());
                ...
                if(matcher.find()){
                    ...
                    check++;
                }else if(htmlstring.toLowerCase().contains(elem.toLowerCase())){
                    System.out.println("\tChecking using contains since matcher failed");
                    foundFile.println(urlstring + " contains \t" + elem);
                    check++; 
                }
            }
